...
<header class="bg-primary text-white">
    <div class="container text-center">
      <?php $ambil=$koneksi->query("SELECT * FROM deskripsi WHERE id_produk='5'");?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">         
          ...
          <div class="caption">
            <div class="thumbnail">
              <img class="card-img-top" src="img/ventela3.jpg" alt="Card image cap" width="300px" height="450px">
            </div>
            ...
            <p align="justify">
              <?php $num_char=565;
                $text = $perproduk['sejarah_produk']; 
                echo substr($text, 748, $num_char); ?></p>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 mx-auto">          
          <div class="thumbnail">
            <img class="card-img-top" src="img/ventela1.jpg" alt="Card image cap" width="300px" height="450px">
          </div>
          <h2 align="center">Perkembangan Ventela</h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <h2>Find Us!</h2>
          <div>             
             <a class="btn" href="https://www.instagram.com/ventelashoes/">
                <i class="fab fa-instagram"></i>
             </a>
             <a class="btn" href="https://www.ventela.com/">Ventela</a>
           </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">      
      <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="brodo.php">&lArr; Brodo</a>
          </li>
          <li class="page-item">
            <a class="page-link" href="wakai.php">Wakai &rArr;</a>
          </li>
        </ul>
      </nav>      
    </div>
