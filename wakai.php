...
<!--judul-->
 <header class="bg-primary text-white">
    <div class="container text-center">
       <?php $ambil=$koneksi->query("SELECT * FROM deskripsi WHERE id_produk='4'");?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">          
          ...
          <div class="caption">
            <div class="thumbnail">
              <img class="card-img-top" src="img/wakai1.jpg" alt="Card image cap">
            </div>            
            <h3 align="center">Sejarah <?php echo $perproduk['nama_produk']; ?></h3>
            <p align="justify">
              <?php $num_char=368;
                $text = $perproduk['sejarah_produk']; 
                echo substr($text, 0, $num_char); ?></p>
            <p align="justify">
              <?php $num_char=1120;
              $text = $perproduk['sejarah_produk']; 
              echo substr($text, 368, $num_char);
              ?></p>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 mx-auto">          
          <div class="thumbnail">
            <img class="card-img-top" src="img/wakai2.jpg" alt="Card image cap" width="300px" height="450px">
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <h2>Find Us!</h2>
          <div>
             <a class="btn" href="https://www.facebook.com/wakaiindonesia/">
                <i class="fab fa-facebook-f"></i>
             </a>                          
             <a class="btn" href="https://www.instagram.com/wakaiindonesia/">
                <i class="fab fa-instagram"></i>
             </a>
             <a class="btn" href="https://twitter.com/Wakai_ID">
                <i class="fab fa-twitter"></i>
             </a>
             <a class="btn" href="https://wakaishoes.jp/cocacola/index.php#home/">Wakai Indonesia</a>
           </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">      
      <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="ventela.php">&lArr; Ventela</a>
          </li>
          <li class="page-item">
            <a class="page-link" href="geoff.php">Geoff Maxx &rArr;</a>
          </li>
        </ul>
      </nav>      
    </div>
